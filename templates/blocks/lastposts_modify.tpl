...
<div class="z-formrow">
    <label for="block_display_text_chars">{gt text='Number of characters to display from text'}</label>
    <input id="block_display_text_chars" type="text" name="display_text_chars" value="{$display_text_chars|safehtml}" size="5" maxlength="5" />
</div>
<div class="z-formrow">

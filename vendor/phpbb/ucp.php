...
switch ($mode)
{
	...
	case 'logout':
		...
		{
            // Zphpbb >
            $user_to_logout = $user->data['user_id'];
            // Zphpbb <
			$user->session_kill();
			$user->session_begin();
			$message = $user->lang['LOGOUT_REDIRECT'];
            // Zphpbb >
            Ztools::ZikulaSessionDestroy($user_to_logout);
            /* this redirect not used for now, as we are in iframe yet, but next user click in main page - user will be anonimous.
            header('Location: ' . zikula_url('Zphpbb', 'user', 'main', false, null, null, true));*/
            // Zphpbb <
		}
		else
		{

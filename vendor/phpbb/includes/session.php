...
class session
{
	...
	*/
	function session_begin($update_session_page = true)
	{
        ...
        // Zphpbb > to allow loading admin index.php
		//if (defined('NEED_SID') && (!isset($_GET['sid']) || $this->session_id !== $_GET['sid']))
		if (defined('NEED_SID') && $this->page['page_name'] != 'index.php' && (!isset($_GET['sid']) || $this->session_id !== $_GET['sid']))
        // Zphpbb <
		{
...
class user extends session
{
	...
	*/
	function setup($lang_set = false, $style = false)
	{
        ...
        // Zphpbb > keep install folder, as it needs module to be installed

		...
		switch ($mode)
		{
			case 'reg_details':
				...
				$template->assign_vars(array(
                    ...
                    // Zphpbb >
					'L_CHANGE_EMAIL'    => $user->lang['CHANGE_EMAIL'],
					'U_CHANGE_EMAIL'    => zikula_chnageemail(false, true),
					'U_CHANGE_PASS'    => zikula_chnagepassword(false, true),
					'U_ZIKULA_PROFILE'    => zikula_profile(false, true),
                    // Zphpbb <
			...
			case 'profile_info':
				...
				if ($submit)
				{
					...
					if (!sizeof($error))
					{
                        ...
                        // Zphpbb >
                        zikula_updateProfile($user->data['user_id'], $sql_ary);
                        // Zphpbb <

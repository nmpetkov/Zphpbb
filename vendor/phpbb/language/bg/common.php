...
$lang = array_merge($lang, array(
    ...
    'DELETE_COOKIES'        => 'Изтрий бисквитки',
   ...
   'UNWATCH_TOPIC_DETAILED'   => 'Сигурен ли сте, че вече не искате да следите темата “%s”?',
    ...
    'ONLINE_USERS_TOTAL'        => 'Общо на линия <strong>%d</strong> потребители :: ',
    'ONLINE_USERS_ZERO_TOTAL'    => 'Общо на линия <strong>0</strong> потребители :: ',
    'ONLINE_USER_TOTAL'            => 'Общо на линия <strong>%d</strong> потребител :: ',
    'OPTIONS'                    => 'Настройки',
    ...
    'SEARCH_SELF'                => 'Собствените мнения',
    'SEARCH_TOPIC'                => 'Търси тази тема…',
    'SEARCH_UNANSWERED'            => 'Теми без отговор',
   ...
   'UNREAD_POSTS'         => 'Непрочетени мнения',
    ...
    'VIEW_ONLINE_TIME'            => 'обновява се на всяка минута',
    'VIEW_ONLINE_TIMES'            => 'обновява се на всеки %d минути',
   ...
   'WATCH_TOPIC_DETAILED'   => 'Сигурен ли сте, че искате да следите темата “%s”?',
    ...
    'tz'                => array(
        ...
        '13'    => 'UTC + 13 часа',
        '14'    => 'UTC + 14 часа',
        'dst'	=> '[ <abbr title="Лятно време">DST</abbr> ]',
    ),

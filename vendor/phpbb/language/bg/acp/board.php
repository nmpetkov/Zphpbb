...
$lang = array_merge($lang, array(
	...
	'ALLOW_GRAVATAR'				=> 'Включи използването на граватари',
	'ALLOW_GRAVATAR_EXPLAIN'		=> 'Позволи на потребителите да използват граватарите, прикачени към техните е-мейл адреси.',    
